        ...
        <div id="containerModificaDati">
            <form id="formModDati" action="modificaDatiEsperto" method="POST" enctype="multipart/form-data">
                <div class="credenziali">
                    ...
                    <input type="text" id="nome" name="nomeEsp" value="${esperto.nome}" onclick="hideElemById('error1')">
                ...
                <div class="credenziali">
                    ...
                    <input type="text" id="cognome" name="cognomeEsp" value="${esperto.cognome}" onclick="hideElemById('error2')">
                ...
                <div class="credenziali">
                    ...
                    <input type="password" id="newPass" name="newPassEsp" onclick="hideElemById('error6')">
                ...
                <div class="credenziali">
                    ...
                    <input type="password" id="confNewPass" name="confNewPassEsp" onclick="hideElemById('error10')">
